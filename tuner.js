function Tuner(){
    ...
    function merge(candidates, toMergeCandidates){
        candidates.JSON(fetch);
        for(var k= 0; k < toMergeCandidates; k++){
            candidates.push(newCandidates[k]);
            candidates.tune();
            candidates.normalize(toMergeCandidates);
        }
        sort(candidates);    
    }
    /*
    ...
    */
    this.tune = function(){
        ...
        for(var i = 0; i < 100; i++){
            ...
            candidates.merge(generateRandomCandidate());
        }
        ...
        while(true){
            ...
            console.log(JSON.workingPieces);
            console.log(fitness);
        }
    };
}